...
> PhotoPrediction prediction_partial_update(uuid, patched_photo_prediction_request=patched_photo_prediction_request)
...
with mosquito_alert.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.prediction_partial_update(uuid, patched_photo_prediction_request=patched_photo_prediction_request)
        print("The response of PhotosApi->prediction_partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PhotosApi->prediction_partial_update: %s\n" % e)
```
...
with mosquito_alert.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.prediction_update(uuid, photo_prediction_request)
        print("The response of PhotosApi->prediction_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PhotosApi->prediction_update: %s\n" % e)
```
