...
**zh_cn** | **str** | 简体中文 | [optional] 

## Example

```python
from mosquito_alert.models.localized_topic_message_title import LocalizedTopicMessageTitle

# TODO update the JSON string below
json = "{}"
# create an instance of LocalizedTopicMessageTitle from a JSON string
localized_topic_message_title_instance = LocalizedTopicMessageTitle.from_json(json)
# print the JSON string representation of the object
print(LocalizedTopicMessageTitle.to_json())

# convert the object into a dict
localized_topic_message_title_dict = localized_topic_message_title_instance.to_dict()
# create an instance of LocalizedTopicMessageTitle from a dict
localized_topic_message_title_from_dict = LocalizedTopicMessageTitle.from_dict(localized_topic_message_title_dict)
```
