...
with mosquito_alert.ApiClient(configuration) as api_client:
    ...
    api_instance = mosquito_alert.PermissionsApi(api_client)

    try:
        api_response = api_instance.retrieve_mine()
        print("The response of PermissionsApi->retrieve_mine:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PermissionsApi->retrieve_mine: %s\n" % e)
```
