...
class TestPatchedPhotoPredictionRequest(unittest.TestCase):
    """PatchedPhotoPredictionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedPhotoPredictionRequest:
        """Test PatchedPhotoPredictionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedPhotoPredictionRequest`
        """
        model = PatchedPhotoPredictionRequest()
        if include_optional:
    ...
    def testPatchedPhotoPredictionRequest(self):
        """Test PatchedPhotoPredictionRequest"""
