...
class TestObservationGeoJsonModelList(unittest.TestCase):
    """ObservationGeoJsonModelList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObservationGeoJsonModelList:
        """Test ObservationGeoJsonModelList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObservationGeoJsonModelList`
        """
        model = ObservationGeoJsonModelList()
        if include_optional:
            return ObservationGeoJsonModelList(
    ...
    def testObservationGeoJsonModelList(self):
        """Test ObservationGeoJsonModelList"""
