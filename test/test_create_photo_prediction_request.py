...
class TestCreatePhotoPredictionRequest(unittest.TestCase):
    """CreatePhotoPredictionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePhotoPredictionRequest:
        """Test CreatePhotoPredictionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePhotoPredictionRequest`
        """
        model = CreatePhotoPredictionRequest()
        if include_optional:
    ...
    def testCreatePhotoPredictionRequest(self):
        """Test CreatePhotoPredictionRequest"""
