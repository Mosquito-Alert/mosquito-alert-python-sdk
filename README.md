...
*IdentificationTasksApi* | [**photos_list**](docs/IdentificationTasksApi.md#photos_list) | **GET** /identification-tasks/{identification_task_uuid}/photos/ | 
*IdentificationTasksApi* | [**photos_retrieve**](docs/IdentificationTasksApi.md#photos_retrieve) | **GET** /identification-tasks/{identification_task_uuid}/photos/{uuid}/ | 
*IdentificationTasksApi* | [**predictions_create**](docs/IdentificationTasksApi.md#predictions_create) | **POST** /identification-tasks/{identification_task_uuid}/predictions/ | 
*IdentificationTasksApi* | [**predictions_destroy**](docs/IdentificationTasksApi.md#predictions_destroy) | **DELETE** /identification-tasks/{identification_task_uuid}/predictions/{photo_uuid}/ | 
*IdentificationTasksApi* | [**predictions_list**](docs/IdentificationTasksApi.md#predictions_list) | **GET** /identification-tasks/{identification_task_uuid}/predictions/ | 
*IdentificationTasksApi* | [**predictions_partial_update**](docs/IdentificationTasksApi.md#predictions_partial_update) | **PATCH** /identification-tasks/{identification_task_uuid}/predictions/{photo_uuid}/ | 
*IdentificationTasksApi* | [**predictions_retrieve**](docs/IdentificationTasksApi.md#predictions_retrieve) | **GET** /identification-tasks/{identification_task_uuid}/predictions/{photo_uuid}/ | 
*IdentificationTasksApi* | [**predictions_update**](docs/IdentificationTasksApi.md#predictions_update) | **PUT** /identification-tasks/{identification_task_uuid}/predictions/{photo_uuid}/ | 
*IdentificationTasksApi* | [**retrieve**](docs/IdentificationTasksApi.md#retrieve) | **GET** /identification-tasks/{uuid}/ | 
...
## Documentation For Models
 ...
 - [IdentificationtasksPredictionsCreateIsFinalPredictionErrorComponent](docs/IdentificationtasksPredictionsCreateIsFinalPredictionErrorComponent.md)
 ...
 - [IdentificationtasksPredictionsPartialUpdateIsFinalPredictionErrorComponent](docs/IdentificationtasksPredictionsPartialUpdateIsFinalPredictionErrorComponent.md)
 ...
 - [IdentificationtasksPredictionsUpdateIsFinalPredictionErrorComponent](docs/IdentificationtasksPredictionsUpdateIsFinalPredictionErrorComponent.md)
