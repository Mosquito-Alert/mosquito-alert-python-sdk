...
class ObservationPredictionRequest(BaseModel):
    """
    ...
    is_executive_validation: Optional[StrictBool] = Field(default=False, description="Whether if the photo prediction will be used as an executive validation for the report.")
    __properties: ClassVar[List[str]] = ["ref_photo_uuid", "is_executive_validation"]
