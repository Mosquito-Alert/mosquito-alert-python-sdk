...
class DetailNotification(BaseModel):
    ...
    body: StrictStr
    seen: StrictBool
    __properties: ClassVar[List[str]] = ["id", "expert_id", "created_at", "title", "body", "seen"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if expert_id (nullable) is None
        # and model_fields_set contains the field
        if self.expert_id is None and "expert_id" in self.model_fields_set:
            _dict['expert_id'] = None
