...
class BreedingsitesCreateLocationTypeErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['location.type']):
            raise ValueError("must be one of enum values ('location.type')")
        return value
