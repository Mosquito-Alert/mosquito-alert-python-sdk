...
class BiteGeoJsonModelGeometry(BaseModel):
    """
    BiteGeoJsonModelGeometry
    """ # noqa: E501
    type: Optional[StrictStr] = None
    coordinates: Optional[Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=2, max_length=3)]] = Field(default=None, json_schema_extra={"examples": [[12.9721, 77.5933]]})
