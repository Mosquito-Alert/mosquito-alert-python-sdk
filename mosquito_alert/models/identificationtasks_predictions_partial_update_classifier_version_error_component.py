...
class IdentificationtasksPredictionsPartialUpdateClassifierVersionErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['classifier_version']):
            raise ValueError("must be one of enum values ('classifier_version')")
        return value
