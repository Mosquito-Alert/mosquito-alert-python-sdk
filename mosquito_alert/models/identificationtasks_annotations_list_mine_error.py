...
class IdentificationtasksAnnotationsListMineError(BaseModel):
    ...
    # data type: IdentificationtasksAnnotationsListMineDecisionLevelErrorComponent
    oneof_schema_8_validator: Optional[IdentificationtasksAnnotationsListMineDecisionLevelErrorComponent] = None
    # data type: IdentificationtasksAnnotationsListMineTypeErrorComponent
    oneof_schema_9_validator: Optional[IdentificationtasksAnnotationsListMineTypeErrorComponent] = None
    # data type: IdentificationtasksAnnotationsListMineOrderByErrorComponent
    oneof_schema_10_validator: Optional[IdentificationtasksAnnotationsListMineOrderByErrorComponent] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, IdentificationtasksAnnotationsListMineUpdatedAtErrorComponent):
            ...
            match += 1
        # validate data type: IdentificationtasksAnnotationsListMineDecisionLevelErrorComponent
        if not isinstance(v, IdentificationtasksAnnotationsListMineDecisionLevelErrorComponent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `IdentificationtasksAnnotationsListMineDecisionLevelErrorComponent`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into IdentificationtasksAnnotationsListMineDecisionLevelErrorComponent
        try:
            instance.actual_instance = IdentificationtasksAnnotationsListMineDecisionLevelErrorComponent.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
