...
class ObservationGeoModel(BaseModel):
    """
    ObservationGeoModel
    """ # noqa: E501
    uuid: UUID
    ...
    identification_taxon_id: Optional[StrictInt]
    __properties: ClassVar[List[str]] = ["uuid", "point", "received_at", "identification_taxon_id"]
