...
class IdentificationtasksListAssigneesErrorComponent(BaseModel):
    """
    IdentificationtasksListAssigneesErrorComponent
    """ # noqa: E501
    attr: StrictStr
    code: StrictStr
    detail: StrictStr
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['assignees']):
            raise ValueError("must be one of enum values ('assignees')")
        return value
