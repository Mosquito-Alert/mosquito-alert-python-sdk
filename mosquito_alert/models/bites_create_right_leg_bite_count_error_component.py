...
class BitesCreateRightLegBiteCountErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['right_leg_bite_count']):
            raise ValueError("must be one of enum values ('right_leg_bite_count')")
        return value
