...
class IdentificationtasksListRevisionTypeErrorComponent(BaseModel):
    """
    IdentificationtasksListRevisionTypeErrorComponent
    """ # noqa: E501
    attr: StrictStr
    code: StrictStr
    detail: StrictStr
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['revision_type']):
            raise ValueError("must be one of enum values ('revision_type')")
        return value
