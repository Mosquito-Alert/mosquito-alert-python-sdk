...
class AuthObtainTokenNonFieldErrorsErrorComponent(BaseModel):
    """
    ...
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['invalid', 'no_active_account', 'null']):
            raise ValueError("must be one of enum values ('invalid', 'no_active_account', 'null')")
        return value
