...
class IdentificationtasksPredictionsCreatePhotoUuidErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['photo_uuid']):
            raise ValueError("must be one of enum values ('photo_uuid')")
        return value
