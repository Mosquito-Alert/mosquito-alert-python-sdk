...
class BitesCreateChestBiteCountErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['chest_bite_count']):
            raise ValueError("must be one of enum values ('chest_bite_count')")
        return value
