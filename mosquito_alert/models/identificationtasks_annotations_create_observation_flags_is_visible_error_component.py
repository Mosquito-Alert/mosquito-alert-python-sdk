...
class IdentificationtasksAnnotationsCreateObservationFlagsIsVisibleErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['observation_flags.is_visible']):
            raise ValueError("must be one of enum values ('observation_flags.is_visible')")
        return value
