...
class BreedingsitesListMineLocationAdmNuts3ErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['location_adm_nuts3']):
            raise ValueError("must be one of enum values ('location_adm_nuts3')")
        return value
