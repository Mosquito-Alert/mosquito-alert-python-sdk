...
class NotificationsCreateMessageBodyNonFieldErrorsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['message.body.non_field_errors']):
            raise ValueError("must be one of enum values ('message.body.non_field_errors')")
        return value
