...
class BreedingsitesListMineLocationCountryIdErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['location_country_id']):
            raise ValueError("must be one of enum values ('location_country_id')")
        return value
