...
class IdentificationtasksPredictionsPartialUpdateBboxYMaxErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['bbox.y_max']):
            raise ValueError("must be one of enum values ('bbox.y_max')")
        return value
