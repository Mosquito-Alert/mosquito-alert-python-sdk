...
class ObservationsCreateUserPerceivedMosquitoAbdomenErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['user_perceived_mosquito_abdomen']):
            raise ValueError("must be one of enum values ('user_perceived_mosquito_abdomen')")
        return value
