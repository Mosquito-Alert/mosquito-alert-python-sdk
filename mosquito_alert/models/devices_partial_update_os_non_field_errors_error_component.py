...
class DevicesPartialUpdateOsNonFieldErrorsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['os.non_field_errors']):
            raise ValueError("must be one of enum values ('os.non_field_errors')")
        return value
