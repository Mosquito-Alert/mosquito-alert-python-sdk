...
class CreateTopicMessageContentRequest(BaseModel):
    """
    CreateTopicMessageContentRequest
    """ # noqa: E501
    title: LocalizedTopicMessageTitleRequest = Field(description="Provide the message's title in all supported languages for this topic")
    body: LocalizedTopicMessageBodyRequest = Field(description="Provide the message's body in all supported languages for this topic")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": LocalizedTopicMessageTitleRequest.from_dict(obj["title"]) if obj.get("title") is not None else None,
            "body": LocalizedTopicMessageBodyRequest.from_dict(obj["body"]) if obj.get("body") is not None else None
        })
        return _obj
