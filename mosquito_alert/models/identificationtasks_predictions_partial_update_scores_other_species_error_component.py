...
class IdentificationtasksPredictionsPartialUpdateScoresOtherSpeciesErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['scores.other_species']):
            raise ValueError("must be one of enum values ('scores.other_species')")
        return value
