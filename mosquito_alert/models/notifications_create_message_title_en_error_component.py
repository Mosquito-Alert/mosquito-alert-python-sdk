...
class NotificationsCreateMessageTitleEnErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['message.title.en']):
            raise ValueError("must be one of enum values ('message.title.en')")
        return value
