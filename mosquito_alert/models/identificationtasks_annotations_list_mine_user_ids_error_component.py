...
class IdentificationtasksAnnotationsListMineUserIdsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['user_ids']):
            raise ValueError("must be one of enum values ('user_ids')")
        return value
