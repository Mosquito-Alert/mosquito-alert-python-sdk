...
class BreedingSitesCreateInPublicAreaErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['in_public_area']):
            raise ValueError("must be one of enum values ('in_public_area')")
        return value
