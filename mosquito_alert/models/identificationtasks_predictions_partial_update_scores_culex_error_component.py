...
class IdentificationtasksPredictionsPartialUpdateScoresCulexErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['scores.culex']):
            raise ValueError("must be one of enum values ('scores.culex')")
        return value
