...
class IdentificationtasksListMineAnnotatorIdsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['annotator_ids']):
            raise ValueError("must be one of enum values ('annotator_ids')")
        return value
