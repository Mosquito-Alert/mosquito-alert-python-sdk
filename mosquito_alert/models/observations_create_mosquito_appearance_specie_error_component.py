...
class ObservationsCreateMosquitoAppearanceSpecieErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['mosquito_appearance.specie']):
            raise ValueError("must be one of enum values ('mosquito_appearance.specie')")
        return value
