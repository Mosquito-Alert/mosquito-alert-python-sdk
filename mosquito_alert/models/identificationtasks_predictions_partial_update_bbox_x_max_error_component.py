...
class IdentificationtasksPredictionsPartialUpdateBboxXMaxErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['bbox.x_max']):
            raise ValueError("must be one of enum values ('bbox.x_max')")
        return value
