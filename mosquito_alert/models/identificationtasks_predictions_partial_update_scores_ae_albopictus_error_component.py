...
class IdentificationtasksPredictionsPartialUpdateScoresAeAlbopictusErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['scores.ae_albopictus']):
            raise ValueError("must be one of enum values ('scores.ae_albopictus')")
        return value
