...
class CreateTopicMessageRequest(BaseModel):
    """
    CreateTopicMessageRequest
    """ # noqa: E501
    content: CreateTopicMessageContentRequest = Field(description="The content of the message for the topic")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": CreateTopicMessageContentRequest.from_dict(obj["content"]) if obj.get("content") is not None else None
        })
        return _obj
