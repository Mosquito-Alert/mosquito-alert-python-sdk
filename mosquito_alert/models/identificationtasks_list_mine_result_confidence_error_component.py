...
class IdentificationtasksListMineResultConfidenceErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['result_confidence']):
            raise ValueError("must be one of enum values ('result_confidence')")
        return value
