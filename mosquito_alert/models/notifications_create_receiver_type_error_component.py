...
class NotificationsCreateReceiverTypeErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['receiver_type']):
            raise ValueError("must be one of enum values ('receiver_type')")
        return value
