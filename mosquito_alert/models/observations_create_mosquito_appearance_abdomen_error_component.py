...
class ObservationsCreateMosquitoAppearanceAbdomenErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['mosquito_appearance.abdomen']):
            raise ValueError("must be one of enum values ('mosquito_appearance.abdomen')")
        return value
