...
class ObservationsCreateMosquitoAppearanceThoraxErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['mosquito_appearance.thorax']):
            raise ValueError("must be one of enum values ('mosquito_appearance.thorax')")
        return value
