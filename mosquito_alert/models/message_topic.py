...
class MessageTopic(BaseModel):
    ...
    MessageTopic
    """ # noqa: E501
    code: Annotated[str, Field(strict=True, max_length=100)] = Field(description="Code for the topic.")
    description: StrictStr = Field(description="Description for the topic, in english.")
