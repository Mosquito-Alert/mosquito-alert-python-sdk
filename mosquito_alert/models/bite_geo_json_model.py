...
class BiteGeoJsonModel(BaseModel):
    """
    BiteGeoJsonModel
    """ # noqa: E501
    type: Optional[StrictStr] = None
    geometry: Optional[BiteGeoJsonModelGeometry] = None
    properties: Optional[BiteGeoJsonModelProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": BiteGeoJsonModelProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
