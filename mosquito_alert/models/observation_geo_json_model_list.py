...
class ObservationGeoJsonModelList(BaseModel):
    """
    ObservationGeoJsonModelList
    """ # noqa: E501
    type: Optional[StrictStr] = None
    features: Optional[List[ObservationGeoJsonModel]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "features": [ObservationGeoJsonModel.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None
        })
        return _obj
