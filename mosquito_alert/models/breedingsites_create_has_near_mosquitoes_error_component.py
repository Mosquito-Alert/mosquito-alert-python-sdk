...
class BreedingsitesCreateHasNearMosquitoesErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['has_near_mosquitoes']):
            raise ValueError("must be one of enum values ('has_near_mosquitoes')")
        return value
