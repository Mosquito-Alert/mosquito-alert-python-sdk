...
class IdentificationtasksPredictionsPartialUpdateScoresAeAegyptiErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['scores.ae_aegypti']):
            raise ValueError("must be one of enum values ('scores.ae_aegypti')")
        return value
