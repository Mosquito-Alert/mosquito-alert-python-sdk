...
class IdentificationtasksListMineResultUncertaintyErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['result_uncertainty']):
            raise ValueError("must be one of enum values ('result_uncertainty')")
        return value
