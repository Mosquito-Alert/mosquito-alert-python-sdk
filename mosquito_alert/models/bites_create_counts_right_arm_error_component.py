...
class BitesCreateCountsRightArmErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['counts.right_arm']):
            raise ValueError("must be one of enum values ('counts.right_arm')")
        return value
