...
class IdentificationtasksAnnotationsListMineValidationError(BaseModel):
    """
    IdentificationtasksAnnotationsListMineValidationError
    """ # noqa: E501
    type: StrictStr
    errors: List[IdentificationtasksAnnotationsListMineError]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "errors": [IdentificationtasksAnnotationsListMineError.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
