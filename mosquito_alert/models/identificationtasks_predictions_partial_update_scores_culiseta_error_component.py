...
class IdentificationtasksPredictionsPartialUpdateScoresCulisetaErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['scores.culiseta']):
            raise ValueError("must be one of enum values ('scores.culiseta')")
        return value
