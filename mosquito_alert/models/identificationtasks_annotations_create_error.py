...
class IdentificationtasksAnnotationsCreateError(BaseModel):
    ...
    # data type: IdentificationtasksAnnotationsCreateBestPhotoIdErrorComponent
    oneof_schema_2_validator: Optional[IdentificationtasksAnnotationsCreateBestPhotoIdErrorComponent] = None
    ...
    actual_instance: Optional[Union[IdentificationtasksAnnotationsCreateBestPhotoIdErrorComponent, IdentificationtasksAnnotationsCreateClassificationConfidenceLabelErrorComponent, IdentificationtasksAnnotationsCreateClassificationNonFieldErrorsErrorComponent, IdentificationtasksAnnotationsCreateClassificationTaxonIdErrorComponent, IdentificationtasksAnnotationsCreateFeedbackNonFieldErrorsErrorComponent, IdentificationtasksAnnotationsCreateFeedbackPublicNoteErrorComponent, IdentificationtasksAnnotationsCreateFeedbackUserNoteErrorComponent, IdentificationtasksAnnotationsCreateIsDecisiveErrorComponent, IdentificationtasksAnnotationsCreateIsFlaggedErrorComponent, IdentificationtasksAnnotationsCreateNonFieldErrorsErrorComponent, IdentificationtasksAnnotationsCreateTagsErrorComponent, IdentificationtasksAnnotationsCreateTagsINDEXErrorComponent]] = None
    one_of_schemas: Set[str] = { "IdentificationtasksAnnotationsCreateBestPhotoIdErrorComponent", "IdentificationtasksAnnotationsCreateClassificationConfidenceLabelErrorComponent", "IdentificationtasksAnnotationsCreateClassificationNonFieldErrorsErrorComponent", "IdentificationtasksAnnotationsCreateClassificationTaxonIdErrorComponent", "IdentificationtasksAnnotationsCreateFeedbackNonFieldErrorsErrorComponent", "IdentificationtasksAnnotationsCreateFeedbackPublicNoteErrorComponent", "IdentificationtasksAnnotationsCreateFeedbackUserNoteErrorComponent", "IdentificationtasksAnnotationsCreateIsDecisiveErrorComponent", "IdentificationtasksAnnotationsCreateIsFlaggedErrorComponent", "IdentificationtasksAnnotationsCreateNonFieldErrorsErrorComponent", "IdentificationtasksAnnotationsCreateTagsErrorComponent", "IdentificationtasksAnnotationsCreateTagsINDEXErrorComponent" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, IdentificationtasksAnnotationsCreateNonFieldErrorsErrorComponent):
            ...
            match += 1
        # validate data type: IdentificationtasksAnnotationsCreateBestPhotoIdErrorComponent
        if not isinstance(v, IdentificationtasksAnnotationsCreateBestPhotoIdErrorComponent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `IdentificationtasksAnnotationsCreateBestPhotoIdErrorComponent`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into IdentificationtasksAnnotationsCreateBestPhotoIdErrorComponent
        try:
            instance.actual_instance = IdentificationtasksAnnotationsCreateBestPhotoIdErrorComponent.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into IdentificationtasksAnnotationsCreateError with oneOf schemas: IdentificationtasksAnnotationsCreateBestPhotoIdErrorComponent, IdentificationtasksAnnotationsCreateClassificationConfidenceLabelErrorComponent, IdentificationtasksAnnotationsCreateClassificationNonFieldErrorsErrorComponent, IdentificationtasksAnnotationsCreateClassificationTaxonIdErrorComponent, IdentificationtasksAnnotationsCreateFeedbackNonFieldErrorsErrorComponent, IdentificationtasksAnnotationsCreateFeedbackPublicNoteErrorComponent, IdentificationtasksAnnotationsCreateFeedbackUserNoteErrorComponent, IdentificationtasksAnnotationsCreateIsDecisiveErrorComponent, IdentificationtasksAnnotationsCreateIsFlaggedErrorComponent, IdentificationtasksAnnotationsCreateNonFieldErrorsErrorComponent, IdentificationtasksAnnotationsCreateTagsErrorComponent, IdentificationtasksAnnotationsCreateTagsINDEXErrorComponent. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], IdentificationtasksAnnotationsCreateBestPhotoIdErrorComponent, IdentificationtasksAnnotationsCreateClassificationConfidenceLabelErrorComponent, IdentificationtasksAnnotationsCreateClassificationNonFieldErrorsErrorComponent, IdentificationtasksAnnotationsCreateClassificationTaxonIdErrorComponent, IdentificationtasksAnnotationsCreateFeedbackNonFieldErrorsErrorComponent, IdentificationtasksAnnotationsCreateFeedbackPublicNoteErrorComponent, IdentificationtasksAnnotationsCreateFeedbackUserNoteErrorComponent, IdentificationtasksAnnotationsCreateIsDecisiveErrorComponent, IdentificationtasksAnnotationsCreateIsFlaggedErrorComponent, IdentificationtasksAnnotationsCreateNonFieldErrorsErrorComponent, IdentificationtasksAnnotationsCreateTagsErrorComponent, IdentificationtasksAnnotationsCreateTagsINDEXErrorComponent]]:
