...
class IdentificationtasksAnnotationsCreateError(BaseModel):
    ...
    # data type: IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent
    oneof_schema_15_validator: Optional[IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, IdentificationtasksAnnotationsCreateIsFlaggedErrorComponent):
            ...
            match += 1
        # validate data type: IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent
        if not isinstance(v, IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent
        try:
            instance.actual_instance = IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
