...
class IdentificationtasksAnnotationsListMineClassificationConfidenceLabelErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['classification_confidence_label']):
            raise ValueError("must be one of enum values ('classification_confidence_label')")
        return value
