...
class ObservationsPredictionCreateRefPhotoUuidErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ref_photo_uuid']):
            raise ValueError("must be one of enum values ('ref_photo_uuid')")
        return value
