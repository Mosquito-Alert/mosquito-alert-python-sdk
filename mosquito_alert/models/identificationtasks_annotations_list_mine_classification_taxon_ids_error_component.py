...
class IdentificationtasksAnnotationsListMineClassificationTaxonIdsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['classification_taxon_ids']):
            raise ValueError("must be one of enum values ('classification_taxon_ids')")
        return value
