...
class GuestRegistration(BaseModel):
    ...
    GuestRegistration
    """ # noqa: E501
    username: StrictStr = Field(description="UUID randomly generated on phone to identify each unique user. Must be exactly 36 characters (32 hex digits plus 4 hyphens).")
