...
class CampaignsListValidationError(BaseModel):
    """
    CampaignsListValidationError
    """ # noqa: E501
    type: StrictStr
    errors: List[CampaignsListError]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "errors": [CampaignsListError.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
