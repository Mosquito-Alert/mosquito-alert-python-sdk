...
class BitesCreateRightArmBiteCountErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['right_arm_bite_count']):
            raise ValueError("must be one of enum values ('right_arm_bite_count')")
        return value
