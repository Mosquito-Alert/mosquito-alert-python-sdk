...
class DevicesPartialUpdateMobileAppPackageNameErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['mobile_app.package_name']):
            raise ValueError("must be one of enum values ('mobile_app.package_name')")
        return value
