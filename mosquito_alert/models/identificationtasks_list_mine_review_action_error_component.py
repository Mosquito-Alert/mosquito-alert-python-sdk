...
class IdentificationtasksListMineReviewActionErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['review_action']):
            raise ValueError("must be one of enum values ('review_action')")
        return value
