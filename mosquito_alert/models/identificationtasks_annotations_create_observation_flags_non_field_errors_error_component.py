...
class IdentificationtasksAnnotationsCreateObservationFlagsNonFieldErrorsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['observation_flags.non_field_errors']):
            raise ValueError("must be one of enum values ('observation_flags.non_field_errors')")
        return value
