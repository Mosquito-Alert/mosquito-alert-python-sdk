...
class ObservationsCreateMosquitoAppearanceNonFieldErrorsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['mosquito_appearance.non_field_errors']):
            raise ValueError("must be one of enum values ('mosquito_appearance.non_field_errors')")
        return value
