...
class IdentificationtasksAnnotationsCreateFeedbackNonFieldErrorsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['feedback.non_field_errors']):
            raise ValueError("must be one of enum values ('feedback.non_field_errors')")
        return value
