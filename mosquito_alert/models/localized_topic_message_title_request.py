...
class LocalizedTopicMessageTitleRequest(BaseModel):
    """
    ...
    eu: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, description="Basque")
    ...
    zh_cn: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, description="简体中文", alias="zh-cn")
