...
class IdentificationtasksAnnotationsCreateObservationFlagsIsFavouriteErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['observation_flags.is_favourite']):
            raise ValueError("must be one of enum values ('observation_flags.is_favourite')")
        return value
