...
class IdentificationtasksAnnotationsCreateIsFlaggedErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['is_flagged']):
            raise ValueError("must be one of enum values ('is_flagged')")
        return value
