...
class ObservationsCreateEventEnvironmentErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['event_environment']):
            raise ValueError("must be one of enum values ('event_environment')")
        return value
