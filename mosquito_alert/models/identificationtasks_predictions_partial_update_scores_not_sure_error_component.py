...
class IdentificationtasksPredictionsPartialUpdateScoresNotSureErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['scores.not_sure']):
            raise ValueError("must be one of enum values ('scores.not_sure')")
        return value
