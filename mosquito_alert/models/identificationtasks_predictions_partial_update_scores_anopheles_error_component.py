...
class IdentificationtasksPredictionsPartialUpdateScoresAnophelesErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['scores.anopheles']):
            raise ValueError("must be one of enum values ('scores.anopheles')")
        return value
