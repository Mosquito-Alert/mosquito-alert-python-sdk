...
class BitesCreateLeftLegBiteCountErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['left_leg_bite_count']):
            raise ValueError("must be one of enum values ('left_leg_bite_count')")
        return value
