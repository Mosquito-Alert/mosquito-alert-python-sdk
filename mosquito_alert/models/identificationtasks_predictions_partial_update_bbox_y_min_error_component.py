...
class IdentificationtasksPredictionsPartialUpdateBboxYMinErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['bbox.y_min']):
            raise ValueError("must be one of enum values ('bbox.y_min')")
        return value
