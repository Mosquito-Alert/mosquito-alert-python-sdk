...
class IdentificationtasksPredictionsUpdateError(BaseModel):
    ...
    # data type: IdentificationtasksPredictionsUpdateIsFinalPredictionErrorComponent
    oneof_schema_10_validator: Optional[IdentificationtasksPredictionsUpdateIsFinalPredictionErrorComponent] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, IdentificationtasksPredictionsUpdateThresholdDeviationErrorComponent):
            ...
            match += 1
        # validate data type: IdentificationtasksPredictionsUpdateIsFinalPredictionErrorComponent
        if not isinstance(v, IdentificationtasksPredictionsUpdateIsFinalPredictionErrorComponent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `IdentificationtasksPredictionsUpdateIsFinalPredictionErrorComponent`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into IdentificationtasksPredictionsUpdateIsFinalPredictionErrorComponent
        try:
            instance.actual_instance = IdentificationtasksPredictionsUpdateIsFinalPredictionErrorComponent.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
