...
class ObservationsPredictionCreateIsExecutiveValidationErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['is_executive_validation']):
            raise ValueError("must be one of enum values ('is_executive_validation')")
        return value
