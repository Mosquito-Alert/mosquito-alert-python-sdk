...
class IdentificationtasksPredictionsPartialUpdateBboxXMinErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['bbox.x_min']):
            raise ValueError("must be one of enum values ('bbox.x_min')")
        return value
