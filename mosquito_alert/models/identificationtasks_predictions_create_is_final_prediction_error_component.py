...
class IdentificationtasksPredictionsCreateIsFinalPredictionErrorComponent(BaseModel):
    """
    IdentificationtasksPredictionsCreateIsFinalPredictionErrorComponent
    """ # noqa: E501
    attr: StrictStr
    code: StrictStr
    detail: StrictStr
