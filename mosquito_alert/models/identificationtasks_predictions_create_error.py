...
class IdentificationtasksPredictionsCreateError(BaseModel):
    ...
    # data type: IdentificationtasksPredictionsCreateIsDecisiveErrorComponent
    oneof_schema_11_validator: Optional[IdentificationtasksPredictionsCreateIsDecisiveErrorComponent] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, IdentificationtasksPredictionsCreateThresholdDeviationErrorComponent):
            ...
            match += 1
        # validate data type: IdentificationtasksPredictionsCreateIsDecisiveErrorComponent
        if not isinstance(v, IdentificationtasksPredictionsCreateIsDecisiveErrorComponent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `IdentificationtasksPredictionsCreateIsDecisiveErrorComponent`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into IdentificationtasksPredictionsCreateIsDecisiveErrorComponent
        try:
            instance.actual_instance = IdentificationtasksPredictionsCreateIsDecisiveErrorComponent.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
