...
class IdentificationtasksListMineAssigneeIdsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['assignee_ids']):
            raise ValueError("must be one of enum values ('assignee_ids')")
        return value
