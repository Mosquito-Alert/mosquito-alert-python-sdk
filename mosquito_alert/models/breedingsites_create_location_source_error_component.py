...
class BreedingsitesCreateLocationSourceErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['location.source']):
            raise ValueError("must be one of enum values ('location.source')")
        return value
