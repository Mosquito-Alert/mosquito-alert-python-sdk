...
class DevicesPartialUpdateMobileAppNonFieldErrorsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['mobile_app.non_field_errors']):
            raise ValueError("must be one of enum values ('mobile_app.non_field_errors')")
        return value
