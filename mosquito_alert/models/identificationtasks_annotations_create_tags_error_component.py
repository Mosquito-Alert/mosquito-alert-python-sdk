...
class IdentificationtasksAnnotationsCreateTagsErrorComponent(BaseModel):
    """
    ...
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['invalid_json', 'not_a_list', 'not_a_str', 'null']):
            raise ValueError("must be one of enum values ('invalid_json', 'not_a_list', 'not_a_str', 'null')")
        return value
