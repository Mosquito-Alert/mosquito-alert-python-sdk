...
class PaginatedWorkspaceCollaborationGroupList(BaseModel):
    """
    ...
    results: List[WorkspaceCollaborationGroup]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [WorkspaceCollaborationGroup.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
