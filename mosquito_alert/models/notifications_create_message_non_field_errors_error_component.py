...
class NotificationsCreateMessageNonFieldErrorsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['message.non_field_errors']):
            raise ValueError("must be one of enum values ('message.non_field_errors')")
        return value
