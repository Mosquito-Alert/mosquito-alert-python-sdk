...
class BreedingsitesListMineLocationNuts2ErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['location_nuts_2']):
            raise ValueError("must be one of enum values ('location_nuts_2')")
        return value
