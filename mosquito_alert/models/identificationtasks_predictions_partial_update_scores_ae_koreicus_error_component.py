...
class IdentificationtasksPredictionsPartialUpdateScoresAeKoreicusErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['scores.ae_koreicus']):
            raise ValueError("must be one of enum values ('scores.ae_koreicus')")
        return value
