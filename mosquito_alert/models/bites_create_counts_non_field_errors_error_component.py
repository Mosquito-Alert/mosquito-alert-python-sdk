...
class BitesCreateCountsNonFieldErrorsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['counts.non_field_errors']):
            raise ValueError("must be one of enum values ('counts.non_field_errors')")
        return value
