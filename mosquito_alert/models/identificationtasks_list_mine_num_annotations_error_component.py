...
class IdentificationtasksListMineNumAnnotationsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['num_annotations']):
            raise ValueError("must be one of enum values ('num_annotations')")
        return value
