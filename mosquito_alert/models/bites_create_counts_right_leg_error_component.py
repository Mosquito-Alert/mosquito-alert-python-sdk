...
class BitesCreateCountsRightLegErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['counts.right_leg']):
            raise ValueError("must be one of enum values ('counts.right_leg')")
        return value
