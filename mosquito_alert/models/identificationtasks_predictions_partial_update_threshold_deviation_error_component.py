...
class IdentificationtasksPredictionsPartialUpdateThresholdDeviationErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['threshold_deviation']):
            raise ValueError("must be one of enum values ('threshold_deviation')")
        return value
