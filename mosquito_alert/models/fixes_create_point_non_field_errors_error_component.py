...
class FixesCreatePointNonFieldErrorsErrorComponent(BaseModel):
    """
    ...
    def attr_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['point.non_field_errors']):
            raise ValueError("must be one of enum values ('point.non_field_errors')")
        return value
