...
class PartnersApi:
    ...
    def retrieve(
        self,
        id: Annotated[StrictInt, Field(description="Un valor de entero único que identifique este organization pin.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Un valor de entero único que identifique este organization pin. (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
